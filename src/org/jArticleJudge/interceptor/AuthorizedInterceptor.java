package org.jArticleJudge.interceptor;
...
public class AuthorizedInterceptor  implements HandlerInterceptor {
	...
	/** 定义不需要拦截的请求 */
	private static final String[] IGNORE_URI = {"/loginForm", "/login","/404.html","registerForm","register"};
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (!flag){
        	...
        	if(user == null){
        		...
        		request.getRequestDispatcher(JajConstants.LOGIN).forward(request, response);
        		return flag;
        	}else{
        		 flag = true;
        	}
