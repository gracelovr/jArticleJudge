	 	  ...
	 	  /** 给数据行绑定鼠标覆盖以及鼠标移开事件  */
	 	   ...
	 	   $("#delete").click(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   $.ligerDialog.error("请选择一个需要删除的词条！");
	 		   }else{
	 			   /** 得到用户选中的所有的需要删除的ids */
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除词条",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/word/deleteWord?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="main_locbg font2"><img
				src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：词库管理
				&gt; 词条列表</td>
			<td width="15" height="32"><img
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td height="30">
				<table width="100%" border="0" cellpadding="0" cellspacing="10"
					...
					<tr>
						<td class="fftd">
							<form name="wordform" method="post" id="wordform"
								action="${ctx}/word/selectWord">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">词条内容：<input type="text" name="word_content">
											等级：<input type="text" name="word_lvl"> <input
		...
		<tr valign="top">
			<td align="center" class="font3"><Jaj:pager
					...
					submitUrl="${ctx}/word/selectWord?pageIndex={0}" /></td>
		</tr>
	</table>
