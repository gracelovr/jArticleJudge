	...
	<table width="100%" height="90%" border="0" cellpadding="5"
					...
					<tr>
						<td class="fftd">
							<form name="userform" method="post" id="userform"
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">用户名：<input type="text" name="user_name">
											用户类别：<input type="text" name="user_type"> <input
					...
					<c:forEach items="${requestScope.users}" var="user"
						...
						<tr id="data_${stat.index}" align="center" class="main_trbg"
							...
							<td align="center" width="40px;"><a
								href="${ctx}/user/updateUser?flag=1&id=${user.user_id}"> <img
		...
		<tr valign="top">
			<td align="center" class="font3"><Jaj:pager
					...
					submitUrl="${ctx}/user/selectUser?pageIndex={0}" /></td>
		</tr>
	</table>
