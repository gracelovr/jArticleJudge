...
<body>
	<div style="margin: 10px; background-color: #FFFFFF; text-align: left;">
		<table width="200" height="100%" border="0" cellpadding="0"
			...
			<tr>
				<td id="navbg1" class="left_nav_closed"><div class="font1">用户管理</div></td>
			</tr>
			<tr valign="top" id="submenu1" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
							href="user/selectUser" target="main">用户查询</a></img>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
							href="user/addUser?flag=1" target="main">添加用户</a></img>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td id="navbg2" class="left_nav_closed"><div class="font1">词库管理</div></td>
			</tr>
			<tr valign="top" id="submenu2" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
							href="${ctx}/word/selectWord" target="main">词库查询</a></img>
					</p>
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
							href="${ctx}/word/showAddWordFile" target="main">添加词条</a></img>
					</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td id="navbg3" class="left_nav_closed"><div class="font1">文章管理</div></td>
			</tr>
			<tr valign="top" id="submenu3" style="display: none">
				<td class="left_nav_bgshw" height="50">
					<p class="left_nav_link">
						<img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
							href="${ctx}//showText" target="main">文章列表</a></img>
					</p>
				</td>
			</tr>
			<tr>
