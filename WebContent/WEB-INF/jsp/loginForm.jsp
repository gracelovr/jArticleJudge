	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;"> 日语文章难度分析<font color="#FFCC00">Jaj</font><span
		...
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				...
				<div class="relogin">
					...
					<a type="button" id="register-btn" href="${ctx}/registerForm" class="btn green"
						style="margin-left: 20px">注册<i class="m-icon-swapright m-icon-white"></i> </a>
						 
					</button>
				</div>
			</div>
			<div class="page-footer" style="color: #fff">
				Japanese Article Judge System.
			</div>
		</form>
	</div>
